...
Your task: Create a NotebookLM video from the document below.
...
3. **Generate a video**
   - Use tool: `studio_create` with:
     ...
     - `language`: "es"
     - `confirm`: true
     - `focus_prompt`: Write a 2-3 sentence summary of what the document is about, focusing on the key safety procedures and steps
